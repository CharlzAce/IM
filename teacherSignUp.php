    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (strlen($mname) > 1) {
            ...
            try {
                ...
                $query = "INSERT INTO TEACHER (TEACH_FNAME, TEACH_LNAME, TEACH_INITIAL, TEACH_HOUSE_NO, TEACH_BARANGAY, TEACH_CITY, TEACH_PROVINCE, TEACH_ZIP_CODE, TEACH_EMAIL, TEACH_PASSWORD, TEACH_BDATE, TEACH_PNUMBER,  TEACH_GENDER, ADMIN_ID) 
                VALUES (:FNAME, :LNAME, :MNAME, :HOUSE, :BARANGAY, :CITY, :PROVINCE, :ZIP, :EMAIL, :PW, :DOB, :PHONE, :GENDER, :ID);";
                ...
                $stmt->execute([$fname, $lname, $mname, $house,  $barangay, $city, $province, $zip, $email, $spassword, $dob, $phone, $gender, $ad]);
    
                $pdo = null;
                $stmt = null;
    
                echo "\<script type='text/javascript'> ";
                    echo "window.location.href='teacherSignIn.php';";
                echo "</script>";
                ...
                else if (strpos($error_message, 'Teacher already exists.') !== false)
                    $error_message = "Teacher Already Exists!";
                else
