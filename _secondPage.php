            ...
            <div class="row align-items-start">
                ...
                <div class="col-sm-6 childBox2">
                    ...
                    <h2 class="loginText"><b>Log In</b></h2>
                        <input type="submit" class="btnclck button1" onclick="window.location.href='_thirdPage.php'" value="New Student">
                        <h2>or</h2>
                        <input type="submit" class="btnclck button1" onclick="window.location.href='oldStudentSignIn.php'" value="Old Student">
                    </div>
                </div>
            </div>
        </div>
