    ...
    <body class="gradientBg">
        <section id="header">
            ...
            <div>
                <ul id="navbar">
                    ...
                    <li><a class="active" href="adminFailedExam.php"><i class="fa-solid fa-user"></i>Failed Entrance Exam</a></li>
        ...
        <div class="container">
            ...
            <div class="student-list-container">
                ...
                <?php
                    if($gr != null) {
                        $query = "SELECT * FROM STUDENT WHERE STUD_APPROVAL = 'Failed' AND STUD_GRADE_LEVEL = ?;";
                        $stmt = $pdo->prepare($query);
                        $stmt->execute([$gr]);
...
<?php
    if ($_SERVER["REQUEST_METHOD"] == "POST" && (isset($_POST['studEdit']) || isset($_POST['studDelete']))) {
        ...
        if($stud_edit != null) {
            $query = "UPDATE STUDENT SET STUD_APPROVAL = 'Pending' WHERE STUD_ID = ?;";
            $stmt = $pdo->prepare($query);
