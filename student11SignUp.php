...
<html lang="en">
    <head>
        ...
        <title>ManSci | Grade 11 Sign Up</title>
    </head>
                                    ...
                                    <div class="card-body p-md-5 mx-md-4">
                                        ...
                                        <form id="cusForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                            ...
                                            <div class="d-flex align-items-center justify-content-center">
                                                ...
                                                <button type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-danger gradient-custom-2 btn" onclick="window.location.href='student11SignIn.php'"><b>Sign In</b></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
