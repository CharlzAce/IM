...
<html lang="en">
    <head>
        ...
        <title>ManSci | Gr 7 Dashboard</title>
    ...
    <body class="gradientBg">
        <section id="header">
            ...
            <div>
                <ul id="navbar">
                    <li><a class="active" href="studentDashboard.php"><i class="fa-brands fa-microsoft"></i>Dashboard</a></li>
                    <li><a href="studentEnrollment.php"><i class="fa-solid fa-file"></i>Enrollment</a></li>
     ...
     <div class="margin-center">
        ...
        <section>
            <div class="application-table">
                ...
                <p>Requirements: Grades from grade 6 and Good Moral</p>
