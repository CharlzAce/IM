...
<html lang="en">
    ...
    <body class="gradientBg">
        <section id="header">
            ...
            <div>
                <ul id="navbar">
                    <li><a href="oldStudentDashboard.php"><i class="fa-brands fa-microsoft"></i>Dashboard</a></li>
                    <li><a class="active" href="oldStudentEnrollment.php"><i class="fa-solid fa-file"></i>Enrollment</a></li>
                    <li><a href="oldStudentSubject.php"><i class="fa-solid fa-list"></i>Subject</a></li>
                ...
                <?php
                    ...
                    if($result){
                        foreach($result as $row)
                        {
                            ...
                            <input type="submit" id="btnsbmt" name="btnsbmt" class="btnEdit" value="Submit" <?php if ($approval == 'Pending' || $en == 'Pending' || $en == 'Failed' || $en == 'Approved') echo 'disabled'; ?>>
                            <?php
                        }
                    } 
                    else {
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        try {
            ...
            echo "\<script type='text/javascript'> ";
                echo "window.location.href='_oldEnrollment.php';";
            echo "</script>";
