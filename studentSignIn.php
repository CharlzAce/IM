<?php
    ...
    function authenticateStudent($email, $password, $pdo) {
        $stmt = $pdo->prepare("SELECT * FROM STUDENT WHERE STUD_GRADE_LEVEL = 7 AND STUD_STATUS = 'New' AND STUD_EMAIL = ?");
        $stmt->execute([$email]);
        $admin = $stmt->fetch(PDO::FETCH_ASSOC);
...
<html lang="en">
    <head>
        ...
        <title>ManSci | Grade 7 Sign In</title>
    </head>
                                    ...
                                    <div class="card-body p-md-5 mx-md-4">
                                        ...
                                        <form id="cusLog" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                            ...
                                            <div class="d-flex align-items-center justify-content-center pb-4">
                                                ...
                                                <button type="button" data-mdb-button-init data-mdb-ripple-init class="btn gradient-custom-2 btn" onclick="window.location.href='studentSignUp.php'"><b>Sign Up</b></button>
                                            </div>
