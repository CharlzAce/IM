...
<html lang="en">
    ...
    <body class="gradientBg">
        <section id="header">
            ...
            <div>
                <ul id="navbar">
                    <li><a href="student11Dashboard.php"><i class="fa-brands fa-microsoft"></i>Dashboard</a></li>
                    <li><a href="student11Enrollment.php"><i class="fa-solid fa-user"></i>Enrollment</a></li>
                    <li><a class="active" href="student11Subject.php"><i class="fa-solid fa-chalkboard-user"></i>Subject</a></li>
