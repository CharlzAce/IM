...
<html lang="en">
    <head>
        ...
        <title>ManSci | Admin Enrollment</title>
        ...
        <section id="header">
            ...
            <div>
                <ul id="navbar">
                    ...
                    <li><a class="active" href="adminEnrollment.php"><i class="fa-solid fa-file"></i>Enrollment</a></li>
        ...
        <section>
            <div class="container">
                ...
                <div class="student-list-container">
                    ...
                    <?php
                        if($gr != null) {
                            $query = "SELECT * FROM ENROLLMENT, STUDENT WHERE ENROLLMENT.STUD_ID = STUDENT.STUD_ID AND EN_APPROVAL = 'Pending' AND STUD_GRADE_LEVEL = ?;";
                            $stmt = $pdo->prepare($query);
                            $stmt->execute([$gr]);
                                    ...
                                    ?>
                                        <div class="student-list">
                                            <div class="student-box">
                                                ...
                                                <div class="student-actions">
                                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                                        <button class="edit-btn" id="studEdit" name="studEdit" value="<?= $row['stud_id'];?>" >Approve</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to fail this student?
                </div>
...
<?php
    if ($_SERVER["REQUEST_METHOD"] == "POST" && (isset($_POST['studEdit']) || isset($_POST['studDelete']))) {
        ...
        if($stud_edit != null) {
            $query = "UPDATE ENROLLMENT SET EN_APPROVAL = 'Approved' WHERE STUD_ID = ?;";
            $stmt = $pdo->prepare($query);
            $stmt->execute([$stud_edit]);
    
            echo "\<script type='text/javascript'> ";
            echo "window.location.href='adminEnrollment.php';";  
            echo "</script>";
        }

        if($stud_delete != null) {

            $query = "UPDATE ENROLLMENT SET EN_APPROVAL = 'Failed' WHERE STUD_ID = ?;";
            $stmt = $pdo->prepare($query);
